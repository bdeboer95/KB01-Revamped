...
//	wchar_t wtext[20];
//	mbstowcs(wtext, title, strlen(title) + 1);//Plus null
//	LPWSTR ptr = wtext;
//    // Define the window
//    WNDCLASSEX wcex;
...
//    // Create the window
//	wchar_t wtext2[20];
//	mbstowcs(wtext2, title, strlen(title) + 1);//Plus null
//	LPWSTR ptr2 = wtext2;
//    m_hWnd = CreateWindow( ptr2, ptr2,  windowed ? WS_OVERLAPPEDWINDOW : WS_EX_TOPMOST, CW_USEDEFAULT, 
