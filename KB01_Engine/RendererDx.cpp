...
void RendererDx::SetCamera(VECTOR3 m_right, VECTOR3 cameraPosition, VECTOR3 cameraTarget, VECTOR3 cameraUpVector)
{
	...
	cameraPosition =  static_cast<VECTOR3>(D3DXVECTOR3(0.0f, 0.0f, 0.0f));
